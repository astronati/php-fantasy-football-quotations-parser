...
namespace FFQP\Model {
    ...
    /**
     * A quotation is a values set that is assigned per each footballer after each match day (championship or
     * cup).
     */
    interface QuotationInterface
    {
        ...
        /**
         * Determines if the footballer has been marked as S.V. (without vote) from the newspaper.
         * @return bool
         */
